...
- A barra inferior DEVE ser sólida; a barra superior DEVE transicionar de RGBA translúcido para opaco em sua extensão e conservar uma borda superior visível. Ambas DEVEM respeitar a largura útil do cabeçalho e permanecer alinhadas em claro, escuro, mobile e desktop. [86b8972]
- A flag DEVE permanecer acima da COVER e alinhada ao conjunto de barras, com dobra triangular íntegra, sem corte, gap, sobreposição indevida ou clipping por stage, wrapper, pattern, Hero ou viewport. [86b8972]
