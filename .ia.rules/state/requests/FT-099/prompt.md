# Fonte da FT-099 — publicação controlada da proposta upstream

- Origem: solicitações humanas no Codex.
- Data: 2026-09-25.
- Identidade: usuário mantenedor do repositório corrente.
- Estado de incorporação: vinculada à FT-099.

## Solicitação material

> Continue as TODOs, incluindo as criação a to-do de issue.
...
- As FTs 096 a 098 concluíram a capacidade local e o material sanitizado sem publicação externa; elas permanecem historicamente intactas.
- A FT-099 representa a autorização material nova e exclusivamente operacional para verificar, publicar e registrar a proposta.
- O destino configurado é `jcempro/agents.md`; duplicidade deve ser verificada pelo mecanismo oficial antes da criação.
