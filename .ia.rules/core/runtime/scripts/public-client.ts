...
/** Executa requestJson no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa fetchOnce no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa readLimited no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa failure no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa normalizeFailure no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa httpCode no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa assertPublicHttpsUrl no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa safeCachePath no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa readCache no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa writeCache no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa sanitizeText no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa boundedInt no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
function boundedInt(value, fallback, min, max) {
  const parsed = Number(value);
  return Number.isInteger(parsed) && parsed >= min && parsed <= max ? parsed : fallback;
}

/** Executa delay no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
function delay(ms) {
