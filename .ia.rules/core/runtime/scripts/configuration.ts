...
/** Executa loadConfiguration no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa parseConfig no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa deepMerge no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
