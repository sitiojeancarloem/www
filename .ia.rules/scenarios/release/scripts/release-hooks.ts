...
/** Representa entrada inválida do hook de release sem converter falha de uso em erro interno. */
class UsageError extends Error {}

/** Executa runReleaseHook no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
...
/** Executa optionalHook no fluxo deste módulo; centraliza contrato reutilizável e preserva validações do chamador. */
