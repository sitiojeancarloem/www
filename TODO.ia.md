...
- [x] Corrigir definitivamente a regressão do logotipo na página 404
...
- [x] Normatizar e rotear o modus operandi especializado da IA (específico do projeto)
...
- [x] Tornar todo conteúdo editorial e navegação essencial semanticamente compatíveis com TTS
...
- [x] Padronizar ligações, marcadores e prosódia exclusivos do TTS
...
- [x] Diferenciar citações e referências na leitura TTS sem alterar o texto editorial
...
- [x] Tratar corretamente idiomas e pronúncia no TTS
...
- [x] Tornar tabelas, imagens e gráficos compreensíveis por TTS
...
- [x] Condicionar bibliotecas e assets auxiliares de TTS ao uso efetivo
...
- [x] Validar TTS/acessibilidade como contrato permanente, sem regressões
